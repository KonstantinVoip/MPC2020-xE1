...
int register_netdevice(struct net_device *dev)
{
	...
	printk("!!!net/core.dev.c___Start_register_netdevice__4848!\n");
	...
	printk("!!!net/core.dev.c___4860!!!\n\r");
	
	spin_lock_init(&dev->addr_list_lock);
	netdev_set_addr_lockdep_class(dev);
	netdev_init_queue_locks(dev);
    printk("!!!net/core.dev.c___4865!!!\n\r");
#ifdef CONFIG_NET_GIANFAR_FP
    ...
    printk("!!!net/core.dev.c___4880!!!\n\r");

	if (!dev_valid_name(dev->name)) {
		ret = -EINVAL;
		goto err_uninit;
	}
    printk("!!!net/core.dev.c___4886!!!\n\r");
...
err_uninit:
	printk("???net/core/dev.c__???err_uninit!\n\r");
	if (dev->netdev_ops->ndo_uninit)
		dev->netdev_ops->ndo_uninit(dev);
	goto out;
}
