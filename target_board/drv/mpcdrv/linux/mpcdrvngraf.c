...
/*****************************************************************************/
static inline void parse_pari_svyaznosti(const u32 *in_sviaz_array, u32 *my_ip, u8 *posad_mesto, u8 *mk8_vyhod, u32 *sosed_ip, u8 *sosed_posad_mesto,
      u8 *mk8_sosed_vyhod);
...
void ngraf_get_ip_mac_my_kys(UINT8 state, UINT32 ip_addres, UINT8 *mac_address)
{
   ...
   printk("State =0x%x>>IP=0x%x,MAC =|0x%02x|0x%02x|0x%02x|0x%02x|0x%02x|0x%02x|\n\r", state, ip_addres, my_current_kos.mac_address[0],
         my_current_kos.mac_address[1], my_current_kos.mac_address[2], my_current_kos.mac_address[3], my_current_kos.mac_address[4],
         my_current_kos.mac_address[5]);
}
/**************************************************************************************************
            ...
            if(l_tdm_input_direction)
            {
               ...
               switch (l_tdm_input_direction)
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?noroutetab_ARP_NMS3->Send  UNICNOWN to IP sosed \n\r");
                     break;
               }
      ...
      if(multipleksor[who_i_am_node].priznac_shcluzovogo == 1)
      {
         ...
         if(priznak_nms3_arp_sender)
         {
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[0] == (UINT8) priznak_kommutacii)
            {
               ...
               printk("S_node=%d_send[0]_ARP_to->ipsosed =%d,tdm_dir->%d\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[0],
                     multipleksor[who_i_am_node].comm.tdm_direction_sosed[0]);
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[0])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_ARP_NMS3->Send_0  UNICNOWN to IP sosed 0x%x direction=%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[0],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[0]);
                     break;
               }
            ...
            {
               //определяем в какое направаление tdm суём
               printk("S_node=%d_send[1]_ARP_to->ipsosed =%d,tdm_dir->%d\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[1],
                     multipleksor[who_i_am_node].comm.tdm_direction_sosed[1]);
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[1])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_ARP_NMS3->Send_1  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[1],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[1]);
                     break;
               }
            ...
            {
               printk("S_node=%d_send[2]_ARP_to->ipsosed =%d,tdm_dir->%d\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[2],
                     multipleksor[who_i_am_node].comm.tdm_direction_sosed[2]);
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[2])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_ARP_NMS3->Send _2 UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[2],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[2]);
                     break;
               }
            ...
            {
               //определяем в какое направаление tdm суём
               printk("S_node=%d_send[3]_ARP_to->ipsosed =%d,tdm_dir->%d\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[3],
                     multipleksor[who_i_am_node].comm.tdm_direction_sosed[3]);
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[3])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_ARP_NMS3->Send_3 UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[3],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[3]);
                     break;
               }
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[0] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[0])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_NMS3->Send_0 UNICNOWN to IP sosed 0x%x direction =%d?\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[0],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[0]);
                     break;
               }
            }      		//end multipleksor[who_i_am_node].comm.ipaddr_sosed[0]==priznak_kommutacii
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[1] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[1])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_NMS3->Send_1  UNICNOWN to IP sosed 0x%x direction =%d?\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[1],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[1]);
                     break;
               }
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[2] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[2])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_NMS3->Send_2 UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", who_i_am_node, multipleksor[who_i_am_node].comm.ipaddr_sosed[2],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[2]);
                     break;
               }
            }      		//end multipleksor[who_i_am_node].comm.ipaddr_sosed[2]==priznak_kommutacii
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[3] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[3])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?S_NMS3->Send_3  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[3],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[3]);
                     break;
               }
               ...
               if(!l_tdm_arp_direction == 0)
               {
                  ...
                  switch (l_tdm_arp_direction)
                  {
                     ...
                     case 8:
                        ...
                        break;
                     default:
                        printk("?E_ARP_NMS3->Send_0 UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[0],
                              multipleksor[who_i_am_node].comm.tdm_direction_sosed[0]);
                        break;
                  }
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[1] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[1])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_ARP_NMS3->Send_1  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[1],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[1]);
                     break;
               }
               l_tdm_arp_direction = 0;
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[2] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[2])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_ARP_NMS3->Send_2  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[2],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[2]);
                     break;
               }
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[3] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[3])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_ARP_NMS3->Send_3  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[3],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[3]);
                     break;
               }
               l_tdm_arp_direction = 0;
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[0] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[0])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_NMS3->Send_0  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[0],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[0]);
                     break;
               }
            }    		   //end multipleksor[who_i_am_node].comm.ipaddr_sosed[0]==priznak_kommutacii
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[1] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[1])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_NMS3->Send_1  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[1],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[1]);
                     break;
               }
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[2] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[2])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_NMS3->Send_2  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[2],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[2]);
                     break;
               }
            }    		   //end multipleksor[who_i_am_node].comm.ipaddr_sosed[2]==priznak_kommutacii
            ...
            if(multipleksor[who_i_am_node].comm.ipaddr_sosed[3] == (UINT8) priznak_kommutacii)
            {
               ...
               switch (multipleksor[who_i_am_node].comm.tdm_direction_sosed[3])
               {
                  ...
                  case 8:
                     ...
                     break;
                  default:
                     printk("?E_NMS3->Send_3  UNICNOWN to IP sosed 0x%x direction  =%d?\n\r", multipleksor[who_i_am_node].comm.ipaddr_sosed[3],
                           multipleksor[who_i_am_node].comm.tdm_direction_sosed[3]);
                     break;
               }
...
//#if 0   
   ...
   if(scluz_ip_addres == 0)
   {
      printk("?bad scluz_ip_address =0?\n\r");
      return -1;
   }

   if(my_current_kos.ip_addres == 0)
   {
      printk("?bad current_kos.ip_addres exit=0?\n\r");
      return -1;
   }
   ...
   if(razmer_data_graf_massive < 12)
   {
      printk("?bad razmer_data_graf_massive =%d bait?\n\r", razmer_data_graf_massive);
      return -1;
   }
   ...
   for (i = 0; i < number_of_par_sviaznosti_in_packet; i++)
   {
      ...
      //#if 0 
      parse_pari_svyaznosti(&data_graf_massive[dlinna_pari_sviaznosti_byte], &l_ipaddr, &my_posad_mesto, &my_mk8_vihod, &sosed_ipaddr, &sosed_posad_mesto,
            &sosed_mk8_vyhod);
      //1 элемент в свзяи
   ...
   for (i = 0; i < num_of_svyazi_all; i++)
   {
      c[(UINT8) num_pari[i].ip_addr]++;
   }
