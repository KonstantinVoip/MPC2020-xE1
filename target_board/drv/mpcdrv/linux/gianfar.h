...
//extern void gfar_1588_start(struct net_device *dev);  //kosta comment 11.06.13
//extern void gfar_1588_stop(struct net_device *dev);   //kosta comment 11.06.13
//extern int gfar_ptp_init(struct gfar_private *priv);  //kosta comment 11.06.13
//extern void gfar_ptp_cleanup(struct gfar_private *priv); //kosta comment 11.06.13
//extern int gfar_ptp_do_txstamp(struct sk_buff *skb);  //kosta comment 11.06.13
