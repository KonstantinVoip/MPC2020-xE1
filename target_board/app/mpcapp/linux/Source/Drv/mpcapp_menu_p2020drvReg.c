...
******************************************************************************
*
* Module      : mpcapp_menu_p2020drvreg.c
*
* Description : This module implements P2020 API debug menu for read and write register function.
*
